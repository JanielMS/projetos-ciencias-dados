...
# page config
st.set_page_config(page_title='Restaurant KPIs App',
...
def main():
    ...
    photo_url = 'https://images.pexels.com/photos/4992835/pexels-photo-4992835.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
    st.sidebar.title(':orange[Urban Bistro]')
    st.sidebar.write(':grey[Comer bem também é questão de estilo]')
    st.sidebar.image(photo_url)


    opcoes = st.sidebar.selectbox('Menu', ['Dados', 'KPIs', 'Plots', 'Sobre'])
